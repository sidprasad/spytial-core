...
import { ORIENTATION_DESCRIPTION, CYCLIC_DESCRIPTION, ALIGNMENT_DESCRIPTION, GROUPING_FIELD_DESCRIPTION, GROUPING_SELECTOR_DESCRIPTION } from './constants';
...
const ConstraintCard = (props: ConstraintCardProps) => {
    const constraintsToSelectorComponentMap: Record<ConstraintType, React.JSX.Element> = {
        ...
        align: <AlignmentSelector constraintData={props.constraintData} onUpdate={props.onUpdate}/>,
        ...
        <div className={classes}>
            ...
            <div className="input-group"> 
                ...
                <select onChange={ updateFields } value={ props.constraintData.type }>
                    ...
                    <option value="align" title={ALIGNMENT_DESCRIPTION}>Align</option>
