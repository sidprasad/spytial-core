...
|------------|------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| **Python** (sPyTial)        | `pip install spytial`                                | [![PyPI](https://img.shields.io/pypi/v/spytial.svg?label=pypi%3A%20spytial)](https://pypi.org/project/spytial/)             | [siddharthaprasad.com/spytial](https://siddharthaprasad.com/spytial) · [github.com/sidprasad/spytial](https://github.com/sidprasad/spytial) |
